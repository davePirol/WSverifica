...
public class WSConsumer {
    ...
    public int get(String comando,String paramater) {
        int status = 0;
        result = "";
        ...
        try {
            ...
            String url = prefix + "/" + URLEncoder.encode(comando, "UTF-8")+ "/" + URLEncoder.encode(paramater, "UTF-8");// + "=" + URLEncoder.encode(value, "UTF-8");
            serverURL = new URL(url);
            service = (HttpURLConnection) serverURL.openConnection();
            // impostazione header richiesta
            service.setRequestProperty("Host", "localhost");
